...
class StudyGroupServiceImplTest {
    ...
    void createNotice() {
        ...
        Recruitment recruitment2 = new Recruitment("테스트", "내용",member.getNickname(), Tag, ContactType.Offline, "우리집");
    ...
    void findMyNotice() {
        ...
        Recruitment recruitment1 = new Recruitment("테스트1", "내용",member.getNickname(), Tag, ContactType.Offline, "우리집");
        Recruitment recruitment2 = new Recruitment("테스트2", "내용",member.getNickname(), Tag, ContactType.Offline, "우리집");
        recruitmentRepository.addRecruitment(member, recruitment1);
        recruitmentRepository.addRecruitment(member, recruitment2);
        ...
        Recruitment recruitment1_1 = new Recruitment("테스트1_1", "내용",member2.getNickname(), Tag2, ContactType.All, "우리집");
        Recruitment recruitment1_2 = new Recruitment("테스트2_2", "내용",member2.getNickname(), Tag2, ContactType.Online, "우리집");
